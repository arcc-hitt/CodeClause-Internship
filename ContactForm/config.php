...
define('CONTACTFORM_FROM_ADDRESS', 'mahulearchit01@gmail.com');
define('CONTACTFORM_FROM_NAME', 'Contact Form on localhost');
...
define('CONTACTFORM_TO_ADDRESS', 'mahulearchit@gmail.com');
define('CONTACTFORM_TO_NAME', 'Archit Mahule');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'mahulearchit@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'arc-4321');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6Ld7T-MmAAAAAJyiuFgMoxoMdhGTUUGRLKpbIP-s');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6Ld7T-MmAAAAAAbADbKN4AqkDsuMVRT2e6VLmcD8');
